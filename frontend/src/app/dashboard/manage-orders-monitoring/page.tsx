  ...
  return (
    <div className="space-y-6 text-white">
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-3xl sm:text-4xl font-bold text-sky-400">Kelola Order</h1>
          <p className="text-slate-400 mt-1">Daftar order dari pelanggan.</p>
        </div>
      </div>
        ...
        <MonitoringModal
          order={{
            ...
            owner: selectedOrder.owner
              ? { id: selectedOrder.owner.id, name: selectedOrder.owner.firstName || 'User' }
              : undefined
          }}
