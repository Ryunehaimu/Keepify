                ...
                <div>
                  ...
                  {!selectedUserId && (
                    <p className="text-amber-400 text-xs mt-2 flex items-center">
                      ...
                      notes: wajib pilih user untuk membuat order atas nama orang lain.
                    </p>
                  )}
                </div>
              )}
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
            ...
            <div className="bg-slate-700/30 p-6 rounded-lg">
                ...
                <div className="animate-in fade-in slide-in-from-top-4 duration-300 space-y-6 border-l-2 border-emerald-500/30 pl-4 ml-2">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input type="datetime-local" {...register("pickupRequestedDate")} className="w-full px-2 sm:px-4 py-2.5 text-sm sm:text-base bg-slate-700/50 border border-slate-600 rounded-lg [color-scheme:dark]" />
              ...
              <div className="mt-6">
                ...
                <input type="date" {...register("expectedRetrievalDate")} className="w-full px-2 sm:px-4 py-2.5 text-sm sm:text-base bg-slate-700/50 border border-slate-600 rounded-lg [color-scheme:dark]" />
              </div>
            </div>
